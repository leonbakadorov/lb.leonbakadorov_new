...
// 1. KeyGen
export const KeyGen1024 = function () {
    // IND-CPA keypair
    ...
    const hash1 = sha3.sha3_256.create();
...
/*****************************************************************************************************************************/
// 2. Encrypt
export const Encrypt1024 = function (pk) {
    ...
    const hash3 = sha3.sha3_512.create()/*new SHA3(512)*/;
    ...
    const hash4 = sha3.sha3_256.create();
    ...
    const hash5 = sha3.shake256.create();
...
/*****************************************************************************************************************************/
// 3. Decrypt
export const Decrypt1024 = function (c, privateKey) {
    ...
    const hash1 = sha3.sha3_512.create();
    ...
    if (!fail) {
        ...
        const hash3 = sha3.shake256.create();
        ...
        const buffer7 = Buffer.from(ch);
        const hash4 = sha3.shake256.create();
...
function generateMatrixA(seed, transposed) {
    ...
    const xof = sha3.shake128.create()/*new SHAKE(128)*/;
    let ctr = 0;
    for (let i = 0; i < paramsK; i++) {
...
function prf(l, key, nonce) {
    ...
    nonce_arr[0] = nonce;
    const hash = sha3.shake256.create();
    hash.reset();
...
// test run function
export const Test1024 = function () {
